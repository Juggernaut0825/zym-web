      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-[#ddd4c7] pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-6 text-sm text-[#7b766e]">
            <Link href="/privacy.html" className="transition-colors hover:text-[#f28a3a]">Privacy</Link>
            <Link href="/terms.html" className="transition-colors hover:text-[#6c7cf6]">Terms</Link>
          </div>
        </div>
      </div>
    </footer>

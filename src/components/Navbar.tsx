...
export function Navbar() {
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-[#e8e2d8]/90 bg-[#f7f5f0]/92 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-8 md:flex">
          <Link href="/" className="text-[#5f5a52] transition-colors hover:text-[#f28a3a]">
            Home
          </Link>
          <Link href="/features" className="text-[#5f5a52] transition-colors hover:text-[#6c7cf6]">
            Features
          </Link>
          <Link href="/community" className="text-[#5f5a52] transition-colors hover:text-[#f28a3a]">
            Community
          </Link>
